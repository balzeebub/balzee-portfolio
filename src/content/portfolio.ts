...
export type Project = {
  ...
  image?: string;
  /**
   * Optional YouTube link — accepts watch, youtu.be and shorts URLs. When set,
   * the card opens the video in a modal, and if no `image` is given the video's
   * thumbnail becomes the card artwork automatically.
   */
  video?: string;
};
...
export const projects: Project[] = [
  // ---------------------------------------------------------------- video --
  // No `image` on these three on purpose: the card falls back to the YouTube
